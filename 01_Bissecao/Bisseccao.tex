...
Alguns cuidados precisam ser tomados ao utilizar este algoritmo:
...
\end{itemize}
    ...
    Uma equação do tipo $g(x)=x$ pode ser resolvida buscando a raiz de $f(x) = x - g(x)$. Nesta primeira tentativa foi implementado o método da bissecção para buscar o resultado do problema proposto.
